...
//     if (!req.file) {
//       console.log("No file is uploaded yet ");
//     }
...
exports.createWeeklyPerformance = async (req, res) => {
  try {
      const { StudentId, Weekstartingdate, Questionscorrect, Totalquestionsattempted } = req.body;
...
exports.updateWeeklyPerformance = async (req, res) => {
  try {
      const { StudentId, Weekstartingdate, Questionscorrect, Totalquestionsattempted } = req.body;
      const updatedPerformance = await Weeklyperformance.findByIdAndUpdate(req.params.id, {
          StudentId,
          Weekstartingdate,
          Questionscorrect,
          Totalquestionsattempted
...
exports.deleteWeeklyPerformance = async (req, res) => {
  try {
      const deletedPerformance = await Weeklyperformance.findByIdAndDelete(req.params.id);
...
// Controller for fetching all questions
...
// Controller for fetching a specific question by ID
...
// Controller for updating a specific question by ID
exports.updateQuestion = async (req, res) => {
    try {
        const { questionText, answer, relatedWord, difficultyLevel, options } = req.body;
...
// Controller for deleting a specific question by ID
